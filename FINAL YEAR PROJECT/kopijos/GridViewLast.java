...
public class GridView extends VBox {
    ...
    for (int y=0; y<words; y++)
    	{
            ...
            {
            	if((y>=1) && (this.lettermatching(questionPool.get(y-1)) != -1)) {
   ...
   /* private int lettermatching(Questions q) { //FOR ANY LETTER IN THE WORD
    	int n = -1;
    ...
    private int lettermatching(Questions q) { //FOR FIRST LETTER IN THE WORD
    	int n = -1;
    	for (Questions qs : questionPool) {
